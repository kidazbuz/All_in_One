...
# NOTE: Import your models based on where they reside in your project structure.
# Assuming:
# 1. Sale, SaleItem, Customer are in the current app's models.py
# 2. ProductSpecification is in the 'products' app
# 3. WarehouseLocation and StockMovement are in the 'inventory' app
...
class SaleTransactionSerializer(serializers.Serializer):
    ...
    customer_id = serializers.PrimaryKeyRelatedField(
        queryset=Customer.objects.all(), required=False, allow_null=True, source='customer'
    )
