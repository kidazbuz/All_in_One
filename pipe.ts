// src/app/pipes/overall.pipe.ts

import { Pipe, PipeTransform, inject } from '@angular/core';
import { DatePipe } from '@angular/common';

// ====================================================================
// SECTION 1: Data Models (Interfaces)
// These interfaces define the shape of the data used by the pipe.
// ====================================================================

/**
 * Defines the structure of an individual Sales Record item passed into the pipe.
 */
export interface SaleRecord {
  id: number;
  sale_date: string; // The date string from the API (e.g., "2025-11-18T22:55:38.163Z")
  total_amount: string;
  // ... other properties from your API structure ...
}

/**
 * Defines the structure of the grouped output array returned by the pipe.
 */
...
/**
 * Defines the allowed grouping strategies.
 */
export type GroupType = 'daily' | 'weekly' | 'monthly';


// ====================================================================
// SECTION 2: The OverallPipe Implementation
// This pipe handles the logic for grouping and sorting the sales data.
// ====================================================================

@Pipe({
    name: 'overall',
    standalone: true, // Recommended for modern Angular pipes
})
export class OverallPipe implements PipeTransform {
    ...
    /**
     * Groups sales data based on the specified type ('daily', 'weekly', 'monthly').
     * @param salesRecords The list of sales/orders.
     * @param type The grouping strategy to use.
     */
    transform(
        salesRecords: SaleRecord[] | null | undefined,
        type: GroupType
    ): SaleGroup[] {
...
// Example Component (if standalone)
import { CommonModule, DatePipe } from '@angular/common';
import { OverallPipe } from './overall.pipe'; // Adjust path

@Component({
  // ...
  standalone: true,
  imports: [CommonModule, OverallPipe], // Import the pipe here
  providers: [DatePipe], // Must provide DatePipe if the pipe is standalone
  template: `
    <div *ngFor="let group of salesData | overall: 'daily'">
      </div>
  `
})
